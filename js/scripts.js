...
})(window,document,'script','dataLayer','GTM-5H97XG6');
...
function _popover() {
	...
	jQuery("a[data-toggle=popover], button[data-toggle=popover]").popover({
		...
		$(this).popover("show"), $(".popover-title").append('<button type="button" class="close">×</button>'), $(".close").click(function (e) {
...
var _arr = {};
if (/pofweb/.test(self.location.href) || /tstrap/.test(self.location.href), jQuery().mediaelementplayer && jQuery("video").length > 0 && jQuery(".fullscreenbanner video").length < 1 && jQuery(".fullwidthbanner video").length < 1) {
	...
	function (e) {
		...
		e.fn.fitVids = function (e) {
			...
			if (!document.getElementById("fit-vids-style")) {
				...
				a.className = "fit-vids-style", a.id = "fit-vids-style", a.style.display = "none", a.innerHTML = "­<style>                 .fluid-width-video-wrapper {                   width: 100%;                                position: relative;                         padding: 0;                              }                                                                                       .fluid-width-video-wrapper iframe,          .fluid-width-video-wrapper object,          .fluid-width-video-wrapper embed {             position: absolute;                         top: 0;                                     left: 0;                                    width: 100%;                                height: 100%;                            }                                         </style>", o.parentNode.insertBefore(a, o)
			}
